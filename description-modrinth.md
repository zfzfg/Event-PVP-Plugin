...
> ### 💬 Feedback, Feature Requests & Bug Reports Wanted!
> Have an idea for a feature, found a bug, or need help? I'd love to hear from you!  
> You can submit feedback directly via the **[sterra.online Feedback Form](https://sterra.online/?tab=feedback)** (`https://sterra.online/?tab=feedback`).
> 
> - 🔒 **Completely Anonymous:** No account required (adding an email address for replies is completely optional).
> - 💡 **Any Feedback Welcome:** Whether it's a bug report, feature suggestion, question, or general feedback — every message helps shape future updates to meet your needs!
> - 🙏 **Your Input Matters:** Feedback in any form is greatly appreciated and directly helps the ongoing development.

---
![MainScreen](https://cdn.modrinth.com/data/cached_images/55a8bea46817ffd20512a6f86a71b31c436ec2a9.png)
---
...
![DELETEDELETEDELETE](https://cdn.modrinth.com/data/cached_images/cccdf739c9185ab11c8e5d8133bc1504d3125fa1.png)
---
