...
public class ResponseItemSelectionGui extends AbstractWagerGui {
    ...
    public void open() {
        inventory = Bukkit.createInventory(null, SIZE, 
            MessageUtil.color("&6&lDeine Items wählen"));
    ...
    private ItemStack createInfoItem() {
        return createButton(Material.NETHER_STAR, "&e&lAnleitung",
            "",
            "&7Klicke auf Items unten",
            "&7um sie hinzuzufügen.",
            "",
            "&7Klicke auf ausgewählte Items",
            "&7um sie zu entfernen.",
            "",
            "&eLinks-Klick: &f1 Item",
            "&eRechts-Klick: &fGanzer Stack");
    }
